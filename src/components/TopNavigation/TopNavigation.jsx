...
import {faCrown, faFilter, faList, faSearch, faSignOutAlt, faUserAlt} from "@fortawesome/free-solid-svg-icons";
...
export class TopNavigation extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <Formik
                    initialValues={{name: '', date: '', location: '', type: '', entryFee: ''}}
                ...
                >
                    {({
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className={"search-criteria " + (!this.state.filtersOpened ? 'hidden' : '')}>
                                    <div className={"form-row"}>
                                        ...
                                        <div className={"col-sm-4 col-md-3"}>
                                            <div className="form-group">
                                                ...
                                                <Field type="text" name="entryFee" id={"entryFee"}
                                                       className={"form-control form-control-sm"}
