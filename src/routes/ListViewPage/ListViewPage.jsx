      ...
      <div className="vh-100">
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-sm-8 col-md-9 event-details">
              {!item && (
                <div
                  className={
                ...
                >
                  ...
                  <div>
                    Please select an event from the list to see more information
                    about it
                  </div>
                </div>
              )}
