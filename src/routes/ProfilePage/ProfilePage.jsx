...
class ProfilePage extends React.Component {
    ...
    render() {
        const {
            updateUserConst, users, user, events, userEvents, loading,
            match: {
                params: {userId}
            }
        } = this.props;
                                ...
                                <div className={"card-body"}>
                                    <div className={"form-row"}>
                                        ...
                                        <div className={"col-sm-4"}>
                                            ...
                                            <hr/>
                                            {loading && <div className={"d-flex h-100 justify-content-center"}>
                                                <Loader
                                                    type="Triangle"
                                                    color="#00BFFF"
                                                    height={100}
                                            ...
                                            <div className={"no-events text-center"}>
                                                <div><FontAwesomeIcon icon={faBoxOpen} size={"6x"}/></div>
                                                <div className={"mt-2"}>You haven't created any events yet</div>
                                            </div>}
                                        </div>
                                    </div>
                                </div>
